...
public class Application {
    ...
    private static void ifSubMenu() {
        ...
        do {
            ...
            System.out.println("2. 메뉴 이름 혹은 카테고리명으로 검색하여 메뉴목록 보여주기");
    ...
    private static void foreachSubMenu() {
        ...
        do {
            ...
            switch (no) {
                case 1 : menuService.searchMenuByMenuCode(createRandomCodeList()); break;
                case 9 : return;
            }
        } while (true);
    }
    ...
    private static void trimSubMenu() {
        ...
        do {
            ...
            System.out.println("1. 검색조건이 있는 경우 메뉴 코드로 조회, 단 없으면 전체 조회");
